          ...
          <div className="flex items-center gap-4">
            ...
            <div className="hidden lg:flex items-center border border-border rounded-lg overflow-hidden">
              <button
                ...
                className={`p-2 ${gridSize === "large" ? "bg-primary text-primary-foreground" : "bg-card"}`}
              >
                <LayoutGrid className="w-4 h-4" />
              </button>
              <button
                onClick={() => setGridSize("small")}
                className={`p-2 ${gridSize === "small" ? "bg-primary text-primary-foreground" : "bg-card"}`}
              >
        ...
        {showFilters && (
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <Button onClick={() => setPriceRange({ min: "", max: "" })} variant="outline" className="w-full">
                Clear Filters
              </Button>
            </div>
          </motion.div>
